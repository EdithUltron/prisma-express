...
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('STUDENT', 'FACULTY', 'BRANCH_ADMIN', 'EXAM_ADMIN', 'ADMINISTRATION_ADMIN', 'REGISTRAR', 'PRINCIPAL', 'VICE_CHANCELLOR', 'ALUMNI_ADMIN', 'CERTIFICATE_ADMIN', 'SUPERADMIN');
